...
function createElement() {
    ...
    for (let i = 0; i < socialData.length; i++) {
        ...
        if (socialData[i].title === "email") {
            socialItem.innerHTML = `<i class="iconfont i-email"></i>`;
        } else if (socialData[i].title !== "wechat") {
            socialItem.innerHTML = `<i class="iconfont i-${socialLinkData[i].title}"></i>`;
        } else {
            socialItem.innerHTML = `<i class="iconfont i-wechat"></i>
